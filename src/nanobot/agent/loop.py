...
from src.nanobot.agent.skills import BUILTIN_SKILLS_DIR
from src.nanobot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
from src.nanobot.agent.tools.message import MessageTool
from src.nanobot.agent.tools.registry import ToolRegistry
from src.nanobot.agent.tools.shell import ExecTool
from src.nanobot.agent.tools.mission import MissionTool
from src.nanobot.agent.tools.spawn import SpawnTool
from src.nanobot.agent.tools.web import WebFetchTool, WebSearchTool
from src.nanobot.bus.events import InboundMessage, OutboundMessage
from src.nanobot.command import CommandContext, CommandRouter, register_builtin_commands
from src.nanobot.bus.queue import MessageBus
from src.nanobot.providers.base import LLMProvider
from src.nanobot.session.manager import Session, SessionManager
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from src.nanobot.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    def _strip_think(text: str | None) -> str | None:
        ...
        if not text:
            return None
        from src.nanobot.utils.helpers import strip_think
