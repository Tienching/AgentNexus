...
from src.nanobot.mission.context import (
    check_context_budget,
    emergency_truncate,
    truncate_tool_result,
)
from src.nanobot.mission.guards import STABILITY_GUIDELINES, LoopGuard, SessionRepair
from src.nanobot.mission.roles import build_task_prompt
from src.nanobot.mission.types import Mission, Milestone, Task, TaskResult, TokenUsage, _now_ms
...
class MissionExecutor:
    ...
    def _build_tools(self) -> Any:
        ...
        from src.nanobot.agent.tools.filesystem import (
            EditFileTool,
            ListDirTool,
            ReadFileTool,
            WriteFileTool,
