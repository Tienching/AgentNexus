...
from src.core.agent_runtime.providers.base import LLMProvider, LLMResponse, ToolCallRequest

if TYPE_CHECKING:
    from src.core.agent_runtime.providers.registry import ProviderSpec
