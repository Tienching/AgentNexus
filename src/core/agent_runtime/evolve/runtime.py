...
from src.core.agent_runtime.evolve.codebuddy_executor import CodeBuddyExecutor
from src.core.agent_runtime.evolve.identity import IdentityManager
from src.core.agent_runtime.evolve.implementation import (
    WorktreeTaskResult,
...
from src.core.agent_runtime.evolve.models import (
    AssessmentReport,
    EvolutionConfig,
    EvolutionSession,
    EvolutionTask,
...
from src.core.agent_runtime.evolve.prompts import build_assessment_prompt, build_planning_prompt
...
class EvolutionEngine:
    ...
    def _run_shell(self, cmd: str, timeout: int = 30, stdin_data: str | None = None) -> tuple[int, str, str]:
        return implementation_run_shell(self, cmd, timeout, stdin_data=stdin_data)
