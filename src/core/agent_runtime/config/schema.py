...
class EvolutionConfig(Base):
    ...
    def to_engine_config(self) -> "EvolutionConfig":
        ...
        from src.core.agent_runtime.evolve.models import EvolutionConfig as EngineConfig
        return EngineConfig(
...
class Config(BaseSettings):
    ...
    def _match_provider(
        ...
        from src.core.agent_runtime.providers.registry import PROVIDERS, find_by_name
