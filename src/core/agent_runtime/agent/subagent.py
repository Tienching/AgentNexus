...
from src.core.agent_runtime.config.schema import ExecToolConfig
...
if TYPE_CHECKING:
    ...
    from src.core.agent_runtime.swarm import SwarmCoordinator, SwarmMailbox, TeamFile
...
Summarize this naturally for the user. Keep it brief (1-2 sentences). Do not mention technical details like "subagent" or task IDs."""
    ...
    def _build_subagent_prompt(self) -> str:
        ...
        from src.core.agent_runtime.agent.context import ContextBuilder
...
{self.workspace}"""]
    ...
    async def spawn_team(self, team_config: dict) -> str:
        ...
        """
        from src.core.agent_runtime.swarm import TeamFile, TeamMember, SwarmMailbox, SwarmCoordinator
